...
use ChrisS\Redirect\Classes\RedirectRule;
...
class RedirectManagerTest extends PluginTestCase
{
    ...
    {
        $page = Page::load(Theme::getActiveTheme(), 'chriss-redirect-testpage');

        if ($page === null) {
            $page = new Page();
            $page->title = 'Testpage';
            $page->url = '/chriss/redirect/testpage';
            $page->setFileNameAttribute('chriss-redirect-testpage');
            $page->save();
        }
        ...
        $redirect = new Redirect([
            ...
            'from_url' => '/this-should-be-source',
            'cms_page' => 'chriss-redirect-testpage',
            'requirements' => null,
            'status_code' => 302,
        ...
        self::assertInstanceOf(RedirectRule::class, $result);
        self::assertEquals('http://localhost/chriss/redirect/testpage', $manager->getLocation($result));
