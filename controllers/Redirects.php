...
class Redirects extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('ChrisS.Redirect', 'redirect', $sideMenuItemCode);

        $this->requiredPermissions = ['chriss.redirect.access_redirects'];
    ...
    public function update($recordId = null, $context = null)
    {
        ...
        if ($redirect->getAttribute('target_type') === Redirect::TARGET_TYPE_STATIC_PAGE
            ...
            Flash::error(Lang::get('chriss.redirect::lang.flash.static_page_redirect_not_supported'));
    ...
    public function onCreateRedirectFromRequestLogItems()
    {
        ...
        if ($redirectsCreated > 0) {
            ...
            Flash::success(Lang::get(
                'chriss.redirect::lang.flash.success_created_redirects',
                [
