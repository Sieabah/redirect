...
class Logs extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('ChrisS.Redirect', 'redirect', 'logs');
    }
    ...
    public function index_onEmptyLog()
    {
        ...
        Flash::success(Lang::get('chriss.redirect::lang.flash.truncate_success'));
        return $this->listRefresh();
    }
    ...
    public function index_onDelete()
    {
        if (($checkedIds = post('checked', []))
            ...
            Flash::success(Lang::get('chriss.redirect::lang.flash.delete_selected_success'));
        }
        else {
